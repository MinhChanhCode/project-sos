    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeHttpRequests(request -> {
            request
                    ...
                    .requestMatchers(HttpMethod.POST, "/api/v1/menu-items/**").hasAnyRole("ADMIN", "MANAGER")
                    .requestMatchers(HttpMethod.PUT, "/api/v1/menu-items/**").hasAnyRole("ADMIN", "MANAGER")
                    .requestMatchers(HttpMethod.PATCH, "/api/v1/menu-items/**").hasAnyRole("ADMIN", "MANAGER", "STAFF", "KITCHEN")
                    .requestMatchers(HttpMethod.DELETE, "/api/v1/menu-items/**").hasAnyRole("ADMIN", "MANAGER")
